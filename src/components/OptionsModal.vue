...
<template>
  ...
  >
    ...
    <div>
      <LabelOptionsNumber
        :changeProp="Options.setWorkTime"
        :value="Options.workTime"
        text="Focus length"
      />
      <LabelOptionsNumber
        :changeProp="Options.setShortBreak"
        :value="Options.shortBreak"
        text="Short break length"
      />
      <LabelOptionsRadio
        :checked="Options.darkMode"
        :setChecked="Options.toggleDarkMode"
        text="Dark mode"
      />
      <LabelOptionsRadio :checked="Options.sound" :setChecked="Options.toggleSound" text="Sound" />
    </div>
  </div>
</template>
